...
open class CustomUIScrollable(
    ...
    class MyScrollbarInfo(val scrollable: CustomUIScrollable, val direction: UIDirection, val view: SolidRect) {
        ...
        val onScrollPosChange = Signal<CustomUIScrollable>()
    ...
    val onScrollLeftChange: Signal<CustomUIScrollable> get() = horizontal.onScrollPosChange
    ...
    // VERTICAL SCROLLBAR
    val onScrollTopChange: Signal<CustomUIScrollable> get() = vertical.onScrollPosChange
